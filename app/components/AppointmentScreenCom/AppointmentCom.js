...
class AppointmentCom extends Component{
  ...
  render(){
    return(
      <Card style={{ width:345, height:132,marginRight:10, elevation:10,marginTop:10}}>
          ...
          <View>
            ...
            <TouchableOpacity style={{backgroundColor:'#3067F1',marginLeft:177, marginRight:10, position:'absolute', bottom:0.1, padding:3,borderRadius:5, paddingLeft:10, paddingRight:10}}>
                <Text style={{textAlign:'center', color:'#ffffff'}}>Change Reschedule</Text>
            </TouchableOpacity>
          </View>
      </Card>
    )
